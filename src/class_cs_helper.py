...
def dana_instant():
    ...
    if document:
        ...
        for document in document:
            ...
            alamat_dom = document["alamat_domisili"]
            rt_dom = document["rt_domisili"]
            rw_dom = document["rw_domisili"]
            keluarahan_dom = document["kelurahan_domisili"]
            kecamatan_dom = document["kecamatan_domisili"]
            kota_dom = document["kota_domisili"]
            kodepos_dom = document["kodepos_domisili"]
        ...
        # Print the results
            ...
            print(f"Alamat Domisili  : {alamat_dom}, RT {rt_dom}/RW {rw_dom}, Kel. {keluarahan_dom}, Kec. {kecamatan_dom}, {kota_dom}-{kodepos_dom}")
            print("="*len(msg))
            print("")
            coun = coun + 1
    else:
